...
This project is divided into two versions, both of which AIsa has adapted:
...
```bash
curl --location --request POST 'https://api.aisa.one/mj/submit/imagine' \
...
```bash
curl --location --request POST 'https://api.aisa.one/mj/submit/blend' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--data-raw ',
...
```bash
curl --location --request POST 'https://api.aisa.one/mj/submit/describe' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--data-raw ',
...
```bash
curl --location --request POST 'https://api.aisa.one/mj/submit/modal' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--data-raw ''
...
### Submit swap\_face Task ✅

```bash
curl --location --request POST 'https://api.aisa.one/mj/insight-face/swap' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--data-raw ''
...
```bash
curl --location --request POST 'https://api.aisa.one/mj/submit/action' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--data-raw ',
...
```bash
curl --location --request POST 'https://api.aisa.one/mj/submit/upload-discord-images' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Accept: application/json' \
--header 'Content-Type: application/json' \
--data-raw '
...
```bash
curl --location --request POST 'https://api.aisa.one/mj/task/list-by-condition' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Content-Type: application/json' \
--data-raw ''
...
```bash
curl --location --request GET 'https://api.aisa.one/mj/task//fetch' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Content-Type: application/json'
```
...
```bash
curl --location --request GET 'https://api.aisa.one/mj/task//image-seed' \
--header 'Accept: application/json' \
--header 'Authorization: Bearer $API_KEY' \
--header 'Content-Type: application/json'
```

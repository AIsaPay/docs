...
```http
POST https://your-aisa-server-address/v1/realtime/sessions
...
### WebRTC Connection
- URL: `https://your-aisa-server-address/v1/realtime`
...
- URL: `wss://your-aisa-server-address/v1/realtime`
- Query parameters: `model`
- Headers:
...
async function init() {
  ...
  const baseUrl = "https://your-aisa-server-address/v1/realtime";
...
app.get("/session", async (req, res) => {
  const r = await fetch("https://your-aisa-server-address/v1/realtime/sessions", {
    method: "POST",
    headers: {
...
const url = "wss://your-aisa-server-address/v1/realtime?model=gpt-4o-realtime-preview-2024-12-17";
...
url = "wss://your-aisa-server-address/v1/realtime?model=gpt-4o-realtime-preview-2024-12-17"
headers = [
    "Authorization: Bearer " + NEW_API_KEY,
    "OpenAI-Beta: realtime=v1"
]
...
const ws = new WebSocket(
  "wss://your-aisa-server-address/v1/realtime?model=gpt-4o-realtime-preview-2024-12-17",
  [
    "realtime",
    // Authentication

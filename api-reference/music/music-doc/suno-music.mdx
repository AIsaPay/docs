...
```bash
curl --location 'https://your-aisa-server-address/suno/submit/music' \
...
```bash
curl --location 'https://your-aisa-server-address/suno/submit/lyrics' \
--header 'Authorization: Bearer $AISA_API_KEY' \
--header 'Content-Type: application/json' \
--data '{
    "prompt":"dance"
...
```bash
curl --location 'https://your-aisa-server-address/suno/uploads/audio-url' \
--header 'Authorization: Bearer $AISA_API_KEY' \  
--header 'Content-Type: application/json' \
--data '{ 
...
```bash
curl --location 'https://your-aisa-server-address/suno/submit/concat' \
--header 'Authorization: Bearer $AISA_API_KEY' \
--header 'Content-Type: application/json' \  
--data '{
...
```bash
curl --location 'https://your-aisa-server-address/suno/fetch' \
--header 'Authorization: Bearer $AISA_API_KEY' \ 
--header 'Content-Type: application/json' \
--data '{
    "ids":["task_id"], 
...
```bash
curl --location 'https://your-aisa-server-address/suno/fetch/{{task_id}}' \ 
--header 'Authorization: Bearer $AISA_API_KEY'
```
